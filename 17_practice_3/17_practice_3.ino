...
void loop()
{
  ...
  if (dist_raw < _DIST_MIN || dist_raw > _DIST_MAX){
    dist_raw = _DIST_MAX < dist_raw ? _DIST_MAX : _DIST_MIN;
  ...
  dist_ema = dist_ema * (1 - EMA_ALPHA) + dist_raw * EMA_ALPHA; // Put EMA filter code here
      
  duty = my_map(dist_ema, _DIST_MIN, _DIST_MAX, _DUTY_MIN, _DUTY_MAX);
