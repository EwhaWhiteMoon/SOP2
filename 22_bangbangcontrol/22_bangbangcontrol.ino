...
#define _DUTY_MAX 2100 // 2400
#define _DUTY_NEU 1475 // 1475
#define _DUTY_MIN 850 // 550

#define _SERVO_ANGLE_DIFF  100  // Replace with |D - E| degree
#define _SERVO_SPEED       400  // servo speed

#define _BANGBANG_RANGE    925  // duty up and down for bangbang control
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(32, 0.5, 0));
...
float volt_to_distance(int x)
{
  ...
  return 825 + -4.04 * x + 7.32E-03 * x * x + -4.79E-06 * x * x * x;
}
